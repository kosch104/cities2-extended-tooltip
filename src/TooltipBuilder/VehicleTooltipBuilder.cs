...
namespace ExtendedTooltip.TooltipBuilder
{
    internal class VehicleTooltipBuilder : TooltipBuilderBase
    {
        ...
        public void Build(Entity selectedEntity, Entity prefab, TooltipGroup tooltipGroup)
        {
            ...
            if (m_Settings.VehicleState && !isParked)
            {
            ...
            // GARBAGE TRUCKS
            if (m_Settings.VehicleGarbageTruck && isGarbageTruck && !isParked) {
            ...
            // POST VANS
            if (m_Settings.VehiclePostvan && isPostVan && !isParked)
            {
            ...
            if (m_Settings.VehiclePassengerDetails && !isParked && (isPoliceCar || isPersonalCar || isPublicTransport || isTaxi))
            {
                if (m_Settings.VehicleDriver
